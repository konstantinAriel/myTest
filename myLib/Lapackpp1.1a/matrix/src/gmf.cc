  ...
  LaGenMatFloat::LaGenMatFloat(float *d, int m, int n) :v(d, m*n)
{
    if (debug())
    {
        cout << ">>> LaGenMatFloat::LaGenMatFloat(float *d, int m, int n) :v(d, m*n)\n";
    }
...
if (debug())
{
        cout << ">>> LaGenMatFloat& LaGenMatFloat::operator=(float s)\n";
        cout << "       s = " << s << endl;
}
 ...
 LaGenMatFloat&  LaGenMatFloat::resize(const LaGenMatFloat &A)
{
    if (debug())
    {
        cout << ">>> resize(const LaGenMatFloat &A)" << endl;
        cout << "      A: " << A.info() << endl;
    }
...
LaGenMatFloat::LaGenMatFloat(const LaGenMatFloat& X) : v(0)
{
    if (X.debug())
    {
        cout << ">>> LaGenMatFloat::LaGenMatFloat(const LaGenMatFloat& X)\n";
        cout << "X: " << X.info() << endl;
...
LaGenMatFloat& LaGenMatFloat::copy(const LaGenMatFloat& X) 
{
    if (debug())
    {
        cout << ">>> LaGenMatFloat& LaGenMatFloat::copy\
...
if (debug())
{
    cout << ">>> LaGenMatFloat::operator(const LaIndex& const LaIndex&)\n";
}
    LaIndex I, J;
...
ostream& operator<<(ostream& s, const LaGenMatFloat& G)
{
